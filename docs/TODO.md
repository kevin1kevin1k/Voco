...
- [x] 建立專案文件基線
  ...
  完成條件：
  - [x] `docs/PRD.md` 完成並與目前 repo 現況一致
  - [x] `docs/TODO.md` 完成並可作為短中期實作路線圖
  - [x] `README.md` 改寫為真實專案介紹、啟動方式、資料結構與目前限制
  依賴關係：無。
...
- [x] 建立互動與 PWA 驗證流程
  ...
  完成條件：
  - [x] 至少覆蓋首頁切換、Grid 點擊、VSD 熱點點擊的互動測試
  - [x] 定義離線啟動、重新整理、安裝提示的驗證流程
  - [x] 補齊 Lighthouse / PWA / a11y 檢查清單
  依賴關係：User Mode MVP 主要 UI 完成。
  建議產出物：E2E 測試、PWA artifact 檢查、Lighthouse baseline、手動驗證清單、CI 後續需求。
